...
The project is already running and we have several published results, e.g.:

-   A novel framework to evaluate regression performance, called Statistical Agnostic Regression (SAR) [@gorriz2024statistical].
-   We published a paper in the *International Journal of Neural Systems* about a [cross-modality latent variable framework using joint Variational Autoencoders](publications/2024-05-10-bridging/index.qmd) [@martinez-murcia2024].
-   We published a novel paper within the [GENFI](https://www.genfi.org) initiative, in collaboration with the team at the LMU University in Munich [@schönecker2024]
